...
CREATE TABLE tapp (
    ...
    status varchar(50),
    CONSTRAINT tapp_pkey PRIMARY KEY (id),
...
CREATE TABLE tmenu (
    ...
    CONSTRAINT tmenu_code_key UNIQUE (code),
...
CREATE TABLE tprofile (
    ...
    deleted_by varchar(100),
    status varchar(50),
    CONSTRAINT tprofile_pkey PRIMARY KEY (id),
...
CREATE TABLE trole (
    ...
    deleted_by varchar(100),
    status varchar(50),
    CONSTRAINT trole_pkey PRIMARY KEY (id),
...
CREATE TABLE tresource (
    ...
    deleted_by varchar(100),
    status varchar(50),
    CONSTRAINT tresource_pkey PRIMARY KEY (id),
    CONSTRAINT tresource_code_key UNIQUE (code),
...
INSERT INTO tprofile (created_at,deleted_at,updated_at,id,code,module_code,status,vendor_code,created_by,deleted_by,updated_by,"name") VALUES
	 ...
	 ('2026-05-14 11:08:17.867',NULL,NULL,'6e2e0886-bf44-4d79-afda-e11a89726135'::uuid,'PROF_CRM_M_USER','CRM','ACTIVE','','rodrychm@gmail.com',NULL,NULL,'Profile for mobile CRM user'),
	 ('2026-05-19 16:37:23.186',NULL,NULL,'e79973d3-5eb9-45d3-a058-22d467c397ae'::uuid,'PROF_WFL_ADMIN','WFL','ACTIVE','','rodrychm@gmail.com',NULL,NULL,'Admin Profile for Workflow module'),
	 ('2026-06-17 17:45:59.132',NULL,NULL,'af5573b7-3934-4941-9d14-a716154d11a0'::uuid,'PROF_PROD_ADMIN','PROD','ACTIVE','','rodrychm@gmail.com',NULL,NULL,'Admin Profile for Production module'),
...
INSERT INTO trole (created_at,deleted_at,updated_at,id,code,module_code,status,vendor_code,created_by,deleted_by,updated_by,"name") VALUES
	 ...
	 ('2026-05-14 11:06:36.678',NULL,NULL,'4d173108-12ce-4480-90ce-0aed9312af26'::uuid,'ROLE_CRM_M_USER','CRM','ACTIVE','','rodrychm@gmail.com',NULL,NULL,'User mobile CRM'),
	 ('2026-05-19 16:34:54.467',NULL,NULL,'f3473fb0-75ee-4323-83e4-784524bab50c'::uuid,'ROLE_WFL_ADMIN','WFL','ACTIVE','','rodrychm@gmail.com',NULL,NULL,'Admin roel for Workflow'),
	 ('2026-06-17 17:40:56.958',NULL,NULL,'50a3b65f-3f08-4e21-a842-0cc4ee615078'::uuid,'ROLE_PROD_M_ADMIN','PROD','ACTIVE','','rodrychm@gmail.com',NULL,NULL,'Admin role for Production Module'),
	 ('2026-06-18 11:54:08.651',NULL,NULL,'c73da58b-854e-422f-8b50-aaaad2f21d7d'::uuid,'ROLE_WAREHOUSE_M_ADMIN','WAH','ACTIVE','','rodrychm@gmail.com',NULL,NULL,'Admin role for Warehouse Module Mobile'),
...
INSERT INTO tprofile_role (created_at,deleted_at,updated_at,id,profile_id,role_id,status,created_by,deleted_by,updated_by) VALUES
	 ...
	 ('2026-05-14 11:09:10.684',NULL,NULL,'aab7954e-47ab-4e22-80e1-d366b791d2cc'::uuid,'6e2e0886-bf44-4d79-afda-e11a89726135'::uuid,'4d173108-12ce-4480-90ce-0aed9312af26'::uuid,'ACTIVE','rodrychm@gmail.com',NULL,NULL),
	 ('2026-05-19 16:38:16.159',NULL,NULL,'6f7083df-faab-41b5-8ff6-a239840c7808'::uuid,'e79973d3-5eb9-45d3-a058-22d467c397ae'::uuid,'f3473fb0-75ee-4323-83e4-784524bab50c'::uuid,'ACTIVE','rodrychm@gmail.com',NULL,NULL),
...
INSERT INTO tresource (restricted,created_at,deleted_at,updated_at,id,resource_id,code,module_code,status,"type",created_by,deleted_by,updated_by,description,endpoint,"name",menu_id) VALUES
	 ...
	 (true,'2026-02-05 09:33:03.226',NULL,NULL,'cfb86fcd-7d1a-4474-b0fd-eccec69ae575'::uuid,'ffcc8009-4a0f-4e30-8a2f-8dd6f064d1ed'::uuid,'WAH_REP','WAH','ACTIVE','menu','system',NULL,NULL,'Warehouse reports','','Reports','80bf089b-bf98-4088-9b99-0409773e5c67'::uuid),
	 (true,'2026-02-05 09:20:18.338',NULL,'2026-02-05 09:25:09.977','ffcc8009-4a0f-4e30-8a2f-8dd6f064d1ed'::uuid,NULL,'WAH','WAH','ACTIVE','menu','system',NULL,'system','Warehouse menu','','Warehouse','80bf089b-bf98-4088-9b99-0409773e5c67'::uuid),
	 (true,'2026-02-05 09:27:17.471',NULL,NULL,'26748ab3-aaed-4260-a0ff-b62da8e9b4b8'::uuid,'ffcc8009-4a0f-4e30-8a2f-8dd6f064d1ed'::uuid,'WAH_CONF','WAH','ACTIVE','menu','system',NULL,NULL,'Configuration options for warehouse','','Configuration','80bf089b-bf98-4088-9b99-0409773e5c67'::uuid),
	 (true,'2026-02-05 09:35:55.606',NULL,NULL,'eb5340ca-37d4-4ce9-9cc0-bc7f49fb3b45'::uuid,'26748ab3-aaed-4260-a0ff-b62da8e9b4b8'::uuid,'WAH_CONF_WAH','WAH','ACTIVE','menu','system',NULL,NULL,'Warehouse management','/warehouse/warehouse','Warehouse','80bf089b-bf98-4088-9b99-0409773e5c67'::uuid),
	 (true,'2026-02-05 09:40:38.854',NULL,NULL,'6328e0a8-2e01-40a5-8078-b3cc92296c31'::uuid,'a9a8bca1-4a11-44ea-91a5-6ec4c7c4fc53'::uuid,'WAH_MOV_REC','WAH','ACTIVE','view','system',NULL,NULL,'Warehouse Goods receipt','/warehouse/movement/in','Goods receipt','80bf089b-bf98-4088-9b99-0409773e5c67'::uuid),
...
INSERT INTO tresource (restricted,created_at,deleted_at,updated_at,id,resource_id,code,module_code,status,"type",created_by,deleted_by,updated_by,description,endpoint,"name",menu_id) VALUES
	 ...
	 (true,'2026-03-20 06:06:25.846',NULL,NULL,'e5014912-1b7f-49e6-a45f-694d723d2190'::uuid,'19c9cb14-984d-4c26-8639-7e4149fc7750'::uuid,'CRM_CUS','CRM','ACTIVE','view','system',NULL,NULL,'Customers','/crm/person','Customers','80bf089b-bf98-4088-9b99-0409773e5c67'::uuid),
	 (true,'2026-03-20 06:12:30.364',NULL,NULL,'7f040433-f33e-4fad-a850-78ac04902849'::uuid,'19c9cb14-984d-4c26-8639-7e4149fc7750'::uuid,'CRM_SAL','CRM','ACTIVE','view','system',NULL,NULL,'Sales','/crm/sales','Sales','80bf089b-bf98-4088-9b99-0409773e5c67'::uuid),
	 (true,'2026-03-20 06:12:54.348',NULL,NULL,'92644f01-505d-4d3a-b31a-17d920fdcce3'::uuid,'19c9cb14-984d-4c26-8639-7e4149fc7750'::uuid,'CRM_PSA','CRM','ACTIVE','view','system',NULL,NULL,'Post-Sales','/crm/postsales','Post-Sales','80bf089b-bf98-4088-9b99-0409773e5c67'::uuid),
	 (true,'2026-04-02 06:12:49.244',NULL,NULL,'defbef22-0b31-41d4-90a3-dfa7e31b9f23'::uuid,NULL,'OBI','OBI','ACTIVE','menu','system',NULL,NULL,'Obituary','','Obituary','80bf089b-bf98-4088-9b99-0409773e5c67'::uuid),
...
INSERT INTO tresource (restricted,created_at,deleted_at,updated_at,id,resource_id,code,module_code,status,"type",created_by,deleted_by,updated_by,description,endpoint,"name",menu_id) VALUES
	 ...
	 (true,'2026-05-14 11:03:49.105',NULL,NULL,'4b0f823b-f0d1-42ea-ba35-5a12b6e5662b'::uuid,NULL,'CRM-M','CRM','ACTIVE','menu','rodrychm@gmail.com',NULL,NULL,'CRM','','CRM','1d35f153-0a9c-45e7-b155-8966dfcb6269'::uuid),
	 (true,'2026-05-14 11:05:34.211',NULL,NULL,'d1eeab68-e4ff-4968-ac30-7936c2eb8300'::uuid,'4b0f823b-f0d1-42ea-ba35-5a12b6e5662b'::uuid,'CRM-M-APP','CRM','ACTIVE','view','rodrychm@gmail.com',NULL,NULL,'Schdeule an appointment','/crm/commercial/customer-service/create','Appointments','1d35f153-0a9c-45e7-b155-8966dfcb6269'::uuid),
	 (true,'2026-05-19 16:27:13.644',NULL,NULL,'88d651f5-fbd1-4143-a95e-33b298940cd5'::uuid,NULL,'WFL','WFL','ACTIVE','menu','rodrychm@gmail.com',NULL,NULL,'Workflow Menu options','','Workflow','80bf089b-bf98-4088-9b99-0409773e5c67'::uuid),
	 (true,'2026-06-30 12:23:55.462',NULL,NULL,'f1052511-dfb4-4a16-81de-2ade7b566e51'::uuid,'e48709a4-81c5-4b60-bf2a-286d8a59baf6'::uuid,'PARAMETER-M-PAR','PARAM','ACTIVE','view','dev-user',NULL,NULL,'Parameters','/parameter/structure','Parameters','1d35f153-0a9c-45e7-b155-8966dfcb6269'::uuid),
...
INSERT INTO tresource (restricted,created_at,deleted_at,updated_at,id,resource_id,code,module_code,status,"type",created_by,deleted_by,updated_by,description,endpoint,"name",menu_id) VALUES
	 ...
	 (true,'2026-06-17 17:34:07.983',NULL,NULL,'44d0d0dc-66db-472e-aca2-ad41e3c3e0cc'::uuid,'ab88a015-24f3-466f-ba50-24f51cfdf1e5'::uuid,'PROD-ORDER','PROD','ACTIVE','view','rodrychm@gmail.com',NULL,NULL,'Operation Orders','/production/operation-order','Operation Orders','1d35f153-0a9c-45e7-b155-8966dfcb6269'::uuid),
	 (true,'2026-06-17 17:35:13.638',NULL,NULL,'9074a402-5eb2-41e0-8156-05c972ed064c'::uuid,'ab88a015-24f3-466f-ba50-24f51cfdf1e5'::uuid,'PROD-PRODUCTION','PROD','ACTIVE','view','rodrychm@gmail.com',NULL,NULL,'Production','/production/operation','Production','1d35f153-0a9c-45e7-b155-8966dfcb6269'::uuid),
	 (true,'2026-06-18 11:33:05.416',NULL,NULL,'838b9e54-40fe-4fed-8953-bcf2f02fbef2'::uuid,NULL,'WAH-M','WAH','ACTIVE','menu','rodrychm@gmail.com',NULL,NULL,'Warehouse module','/warehouse','Warehouse','1d35f153-0a9c-45e7-b155-8966dfcb6269'::uuid),
	 (true,'2026-06-18 11:37:11.417',NULL,NULL,'fe0012bf-6634-4b27-9c46-f00697c98633'::uuid,'838b9e54-40fe-4fed-8953-bcf2f02fbef2'::uuid,'WAH_CONF-M','WAH','ACTIVE','menu','rodrychm@gmail.com',NULL,NULL,'Configuration module','/warehouse/configuration','Configuration','1d35f153-0a9c-45e7-b155-8966dfcb6269'::uuid),
...
INSERT INTO tresource (restricted,created_at,deleted_at,updated_at,id,resource_id,code,module_code,status,"type",created_by,deleted_by,updated_by,description,endpoint,"name",menu_id) VALUES
	 ...
	 (true,'2026-06-18 11:43:39.655',NULL,NULL,'4f0aa85e-d9d4-414a-bb1d-6bdf8543f2d3'::uuid,'adb4d036-7ef9-4efe-8aed-b81b8150e6fc'::uuid,'WAH_REP_STO-M','WAH','ACTIVE','view','rodrychm@gmail.com',NULL,NULL,'Stock levels','/warehouse/rep_stock','Stock levels','1d35f153-0a9c-45e7-b155-8966dfcb6269'::uuid),
	 (true,'2026-06-18 11:44:13.368',NULL,NULL,'9684c1de-8251-4bbb-b695-e92fa76e3457'::uuid,'adb4d036-7ef9-4efe-8aed-b81b8150e6fc'::uuid,'WAH_REP_DAY-M','WAH','ACTIVE','view','rodrychm@gmail.com',NULL,NULL,'Daily movement','/warehouse/rep_daily','Daily movement','1d35f153-0a9c-45e7-b155-8966dfcb6269'::uuid),
	 (true,'2026-06-18 11:44:43.357',NULL,NULL,'0dfa49df-c34b-45d2-a35a-4259e0b79597'::uuid,'adb4d036-7ef9-4efe-8aed-b81b8150e6fc'::uuid,'WAH_REP_KAR-M','WAH','ACTIVE','view','rodrychm@gmail.com',NULL,NULL,'Kardex','/warehouse/rep_kardex','Kardex','1d35f153-0a9c-45e7-b155-8966dfcb6269'::uuid),
	 (true,'2026-06-21 16:14:40.833',NULL,NULL,'37aa3f87-1d14-4507-b13e-af7266acba85'::uuid,'4b0f823b-f0d1-42ea-ba35-5a12b6e5662b'::uuid,'CRM-M-SALE','CRM','ACTIVE','view','rodrychm@gmail.com',NULL,NULL,'Sales','/crm/sales','Sales','1d35f153-0a9c-45e7-b155-8966dfcb6269'::uuid),
...
INSERT INTO tresource (restricted,created_at,deleted_at,updated_at,id,resource_id,code,module_code,status,"type",created_by,deleted_by,updated_by,description,endpoint,"name",menu_id) VALUES
	 ...
	 (true,'2026-07-13 12:17:11.739',NULL,NULL,'17df9706-349a-40d8-b947-a11ffa90554b'::uuid,'46b8fa34-d506-42f0-9108-93a337b0aaeb'::uuid,'WFL-M-INB','WFL','ACTIVE','view','dev-user',NULL,NULL,'Inbox','/workflow/tasks','Inbox','1d35f153-0a9c-45e7-b155-8966dfcb6269'::uuid),
	 (true,'2026-07-13 12:20:29.709',NULL,NULL,'ab598ac3-a127-4d8d-9e73-e4af8056628e'::uuid,'46b8fa34-d506-42f0-9108-93a337b0aaeb'::uuid,'WFL-M-PRO','WFL','ACTIVE','view','dev-user',NULL,NULL,'BPM Process','/workflow/process','BPM Process','1d35f153-0a9c-45e7-b155-8966dfcb6269'::uuid),
	 (true,'2026-07-13 12:21:02.738',NULL,NULL,'ece5f0e0-4989-4c7c-ad83-586b9f7781a2'::uuid,'46b8fa34-d506-42f0-9108-93a337b0aaeb'::uuid,'WFL-M-ENT','WFL','ACTIVE','view','dev-user',NULL,NULL,'Entities','/workflow/main-entity','Entities','1d35f153-0a9c-45e7-b155-8966dfcb6269'::uuid),
	 (true,'2026-07-23 09:56:46.739',NULL,NULL,'de92092a-f570-4a60-96fc-dd280a6da433'::uuid,NULL,'ACC-M','ACC','ACTIVE','menu','dev-user',NULL,NULL,'Access','','Access','1d35f153-0a9c-45e7-b155-8966dfcb6269'::uuid),
...
INSERT INTO trole_resource (created_at,deleted_at,updated_at,id,resource_id,role_id,status,created_by,deleted_by,updated_by) VALUES
	 ...
	 ('2026-05-19 16:35:29.387',NULL,NULL,'4f9b2b74-96ac-4d9c-8f45-3b1e604f69bb'::uuid,'88d651f5-fbd1-4143-a95e-33b298940cd5'::uuid,'f3473fb0-75ee-4323-83e4-784524bab50c'::uuid,'ACTIVE','rodrychm@gmail.com',NULL,NULL),
	 ('2026-05-19 16:35:29.387',NULL,NULL,'2b4cf9a4-2c9e-4669-911f-99dc1bd43ae3'::uuid,'00ee0b63-9e2a-428e-9b52-464e698747a4'::uuid,'f3473fb0-75ee-4323-83e4-784524bab50c'::uuid,'ACTIVE','rodrychm@gmail.com',NULL,NULL),
	 ('2026-06-17 18:02:32.809',NULL,NULL,'79427793-8f4c-496b-83f1-3f151d4c63cd'::uuid,'9074a402-5eb2-41e0-8156-05c972ed064c'::uuid,'50a3b65f-3f08-4e21-a842-0cc4ee615078'::uuid,'ACTIVE','rodrychm@gmail.com',NULL,NULL),
	 ('2026-06-17 18:02:32.809',NULL,NULL,'6bae6f48-400c-48d5-a930-49c7183cd3ac'::uuid,'d9777303-6d70-4a4d-b64c-1930c155cc2c'::uuid,'50a3b65f-3f08-4e21-a842-0cc4ee615078'::uuid,'ACTIVE','rodrychm@gmail.com',NULL,NULL),
...
INSERT INTO trole_resource (created_at,deleted_at,updated_at,id,resource_id,role_id,status,created_by,deleted_by,updated_by) VALUES
	 ...
	 ('2026-06-18 11:57:08.404',NULL,NULL,'15e52459-8103-4add-aa30-8f3cd4cba4b3'::uuid,'0dfa49df-c34b-45d2-a35a-4259e0b79597'::uuid,'c73da58b-854e-422f-8b50-aaaad2f21d7d'::uuid,'ACTIVE','rodrychm@gmail.com',NULL,NULL),
	 ('2026-06-18 11:57:08.404',NULL,NULL,'a32351eb-5018-4c79-896c-5570f1d25600'::uuid,'4f0aa85e-d9d4-414a-bb1d-6bdf8543f2d3'::uuid,'c73da58b-854e-422f-8b50-aaaad2f21d7d'::uuid,'ACTIVE','rodrychm@gmail.com',NULL,NULL),
	 ('2026-06-18 11:57:08.404',NULL,NULL,'286f0dc7-875b-4272-971c-ad6dd37cee3e'::uuid,'fe0012bf-6634-4b27-9c46-f00697c98633'::uuid,'c73da58b-854e-422f-8b50-aaaad2f21d7d'::uuid,'ACTIVE','rodrychm@gmail.com',NULL,NULL),
	 ('2026-06-18 11:57:08.404',NULL,NULL,'21352647-52fd-4ffa-8818-0c5727f7fffe'::uuid,'9684c1de-8251-4bbb-b695-e92fa76e3457'::uuid,'c73da58b-854e-422f-8b50-aaaad2f21d7d'::uuid,'ACTIVE','rodrychm@gmail.com',NULL,NULL),
...
INSERT INTO trole_resource (created_at,deleted_at,updated_at,id,resource_id,role_id,status,created_by,deleted_by,updated_by) VALUES
	 ...
	 ('2026-06-30 12:34:53.447',NULL,NULL,'34ea115c-cca2-427e-837e-cf565ac00bf6'::uuid,'f1052511-dfb4-4a16-81de-2ade7b566e51'::uuid,'191bc64f-0649-4918-9887-ac054d2c0bdf'::uuid,'ACTIVE','dev-user',NULL,NULL),
	 ('2026-06-30 12:34:53.447',NULL,NULL,'adf90eb9-08cb-4ff7-aa09-1d6414c6ee9a'::uuid,'263fa8dc-1bfc-4a6f-8265-ea76788f9d65'::uuid,'191bc64f-0649-4918-9887-ac054d2c0bdf'::uuid,'ACTIVE','dev-user',NULL,NULL),
	 ('2026-06-30 12:34:53.447',NULL,NULL,'29f4e4cc-3b46-4a6e-b40d-2b5871c097c1'::uuid,'e48709a4-81c5-4b60-bf2a-286d8a59baf6'::uuid,'191bc64f-0649-4918-9887-ac054d2c0bdf'::uuid,'ACTIVE','dev-user',NULL,NULL),
	 ('2026-07-03 15:15:43.564',NULL,NULL,'4b6e0b18-2789-4bc7-97f1-5a31ec2ce075'::uuid,'d61d0e3f-f95f-432b-abea-b0945223f455'::uuid,'4d173108-12ce-4480-90ce-0aed9312af26'::uuid,'ACTIVE','dev-user',NULL,NULL),
...
INSERT INTO trole_resource (created_at,deleted_at,updated_at,id,resource_id,role_id,status,created_by,deleted_by,updated_by) VALUES
	 ...
	 ('2026-07-23 10:33:08.336',NULL,NULL,'e2e79f15-61fa-4753-b43c-d3ede8a34959'::uuid,'6115a0c2-6385-4310-8235-1c0c45fa2691'::uuid,'68fa4a81-c8b4-43cd-8c87-0c5a5361fd76'::uuid,'ACTIVE','dev-user',NULL,NULL),
	 ('2026-07-23 10:33:08.336',NULL,NULL,'e6a4cab0-d148-495e-9f9a-03299126207d'::uuid,'6bcfe2d4-a3a7-49cf-ace2-29d0803e611e'::uuid,'68fa4a81-c8b4-43cd-8c87-0c5a5361fd76'::uuid,'ACTIVE','dev-user',NULL,NULL),
	 ('2026-07-23 10:33:08.336',NULL,NULL,'2f2240ec-1b72-4fa4-9070-42d946df8571'::uuid,'5e3f938c-8cab-4784-ba2f-295e71a64aa0'::uuid,'68fa4a81-c8b4-43cd-8c87-0c5a5361fd76'::uuid,'ACTIVE','dev-user',NULL,NULL),
	 ('2026-07-23 10:33:08.336',NULL,NULL,'86f68bf3-62f9-4111-a509-baf3ad1ef370'::uuid,'9f687da6-67fe-46a5-9ded-b2fa5cf1e5bf'::uuid,'68fa4a81-c8b4-43cd-8c87-0c5a5361fd76'::uuid,'ACTIVE','dev-user',NULL,NULL),
...
INSERT INTO tuser_profile (valid_from,valid_to,created_at,deleted_at,updated_at,id,profile_id,status,user_code,created_by,deleted_by,updated_by) VALUES
	 ...
	 ('2026-04-01','2026-12-31','2026-04-27 09:27:18.406',NULL,NULL,'5ab489ff-fb27-4acc-8283-ee7b885b1680'::uuid,'751a5da0-c5af-4947-8044-2bf9d89fe5ec'::uuid,'ACTIVE','jessica.ribeirodemelo@gmail.com','rodrychm@gmail.com',NULL,NULL),
	 ('2026-04-01','2026-12-31','2026-05-06 17:25:16.011',NULL,NULL,'dce746fa-28ba-4183-8245-ecdef7bd6fd7'::uuid,'6be11d65-f359-4573-b4fc-c6b2d4186773'::uuid,'ACTIVE','rodrigochumaceromoscoso@gmail.com','rodrychm@gmail.com',NULL,NULL),
	 ('2026-04-01','2026-12-31','2026-05-06 17:25:16.080',NULL,NULL,'8e5e1af2-eeb7-4aa3-989f-dc17345527ee'::uuid,'751a5da0-c5af-4947-8044-2bf9d89fe5ec'::uuid,'ACTIVE','rodrigochumaceromoscoso@gmail.com','rodrychm@gmail.com',NULL,NULL),
	 ('2026-04-01','2026-12-31','2026-05-14 10:58:20.981',NULL,NULL,'a7b0c944-8c33-4055-a774-7f5240cff50c'::uuid,'751a5da0-c5af-4947-8044-2bf9d89fe5ec'::uuid,'ACTIVE','miguel.ale19934@gmail.com','rodrychm@gmail.com',NULL,NULL),
	 ('2026-04-01','2026-12-31','2026-05-14 11:09:59.946',NULL,NULL,'08defdd7-4649-4317-a4fa-e7e86c9ebafd'::uuid,'6e2e0886-bf44-4d79-afda-e11a89726135'::uuid,'ACTIVE','rodrychm@gmail.com','rodrychm@gmail.com',NULL,NULL),
...
INSERT INTO tuser_profile (valid_from,valid_to,created_at,deleted_at,updated_at,id,profile_id,status,user_code,created_by,deleted_by,updated_by) VALUES
	 ...
	 ('2026-04-01','2026-12-31','2026-07-08 19:50:43.113',NULL,NULL,'e971dc9a-0886-4b36-a10e-119bb8aa37cf'::uuid,'024a1836-7d09-4ab8-a1d2-6b11eb764a67'::uuid,'ACTIVE','vendor1','dev-user',NULL,NULL),
	 ('2026-04-01','2026-12-31','2026-07-08 20:19:36.657',NULL,NULL,'53f4e170-371e-4490-b61e-77238d185781'::uuid,'af5573b7-3934-4941-9d14-a716154d11a0'::uuid,'ACTIVE','vendor1','dev-user',NULL,NULL),
	 ('2026-04-01','2026-12-31','2026-07-12 18:19:33.062',NULL,NULL,'fc59cfec-d47b-4d07-b551-e6960d37e3dd'::uuid,'024a1836-7d09-4ab8-a1d2-6b11eb764a67'::uuid,'ACTIVE','vendor2','dev-user',NULL,NULL),
	 ('2026-04-01','2026-12-31','2026-07-12 18:19:33.163',NULL,NULL,'51863c08-a068-4634-a789-d013c4674ec8'::uuid,'af5573b7-3934-4941-9d14-a716154d11a0'::uuid,'ACTIVE','vendor2','dev-user',NULL,NULL),
...
INSERT INTO tuser_profile (valid_from,valid_to,created_at,deleted_at,updated_at,id,profile_id,status,user_code,created_by,deleted_by,updated_by) VALUES
	 ...
	 ('2026-04-01','2026-12-31','2026-07-13 12:25:05.211',NULL,NULL,'fc210ed7-3c07-4592-ae61-517a6b8be188'::uuid,'feee530c-717c-41e1-ab32-e5c377ed5eb0'::uuid,'ACTIVE','rodrychm@gmail.com','dev-user',NULL,NULL),
...
INSERT INTO tlocal_translation (language_code, domain, entity, entity_id, text) VALUES
    ('es', 'access', 'resource', 'a9a8bca1-4a11-44ea-91a5-6ec4c7c4fc53', '{"name": "Movimientos", "description": "Movimientos de almacén"}'),
    ('es', 'access', 'resource', 'cfb86fcd-7d1a-4474-b0fd-eccec69ae575', '{"name": "Reportes", "description": "Reportes de almacén"}'),
    ('es', 'access', 'resource', 'ffcc8009-4a0f-4e30-8a2f-8dd6f064d1ed', '{"name": "Almacén", "description": "Menú de almacén"}'),
    ('es', 'access', 'resource', '26748ab3-aaed-4260-a0ff-b62da8e9b4b8', '{"name": "Configuración", "description": "Opciones de configuración de almacén"}'),
    ('es', 'access', 'resource', 'eb5340ca-37d4-4ce9-9cc0-bc7f49fb3b45', '{"name": "Almacén", "description": "Gestión de almacenes"}'),
    ('es', 'access', 'resource', '6328e0a8-2e01-40a5-8078-b3cc92296c31', '{"name": "Ingreso de mercadería", "description": "Ingreso de mercadería"}'),
    ('es', 'access', 'resource', '4c6d9bb2-2f86-4ca7-8a94-ad0700b84a9a', '{"name": "Salida de mercadería", "description": "Salida de mercadería"}'),
    ('es', 'access', 'resource', 'f5504425-e972-465d-94ea-7150ebc98b41', '{"name": "Inventario", "description": "Inventario físico de almacén"}'),
    ('es', 'access', 'resource', '581baa05-206c-42d7-829e-d063210fd6f3', '{"name": "Movimiento diario", "description": "Reporte diario de movimientos"}'),
    ('es', 'access', 'resource', 'ca083a13-af05-4c63-b0a3-5dd1afd14c0f', '{"name": "Kárdex de material", "description": "Kárdex físico de material"}'),
    ('es', 'access', 'resource', '22fdecde-84a8-460a-afb1-8c95d7389e35', '{"name": "Nivel de stock", "description": "Nivel de stock por almacén"}'),
    ('es', 'access', 'resource', '19c9cb14-984d-4c26-8639-7e4149fc7750', '{"name": "CRM", "description": "CRM Menú de opciones"}'),
    ('es', 'access', 'resource', 'e5014912-1b7f-49e6-a45f-694d723d2190', '{"name": "Clientes", "description": "Clientes de CRM"}'),
    ('es', 'access', 'resource', '7f040433-f33e-4fad-a850-78ac04902849', '{"name": "Ventas", "description": "Ventas de CRM"}'),
    ('es', 'access', 'resource', '92644f01-505d-4d3a-b31a-17d920fdcce3', '{"name": "Post-Ventas", "description": "Post-Ventas de CRM"}'),
    ('es', 'access', 'resource', 'defbef22-0b31-41d4-90a3-dfa7e31b9f23', '{"name": "Obituario", "description": "Gestión de obituarios"}'),
    ('es', 'access', 'resource', '90e91cdf-1904-4c70-a99b-60b2b27ebc0f', '{"name": "Obituario", "description": "Visualización de obituarios"}'),
    ('es', 'access', 'resource', 'e6ea9b99-9b63-4115-b586-9b576298163e', '{"name": "Campañas", "description": "Definición de campañas de CRM"}'),
    ('es', 'access', 'resource', '11617077-c6f5-41d5-b64f-6692b697a448', '{"name": "Campaña general", "description": "Campaña general de CRM"}'),
    ('es', 'access', 'resource', 'ca69f358-a52a-4592-b65b-3ceb0938408b', '{"name": "Campaña personalizada", "description": "Campaña personalizada de CRM"}'),
    ('es', 'access', 'resource', '86ff7833-11c8-44b9-a239-29858fac82c6', '{"name": "Servicio al cliente", "description": "Servicio al cliente de CRM"}'),
    ('es', 'access', 'resource', 'e19c0cd7-efdb-4c46-8cc7-d2cb65baa7f2', '{"name": "Agendar cita", "description": "Agendar y programar cita"}'),
    ('es', 'access', 'resource', '4b0f823b-f0d1-42ea-ba35-5a12b6e5662b', '{"name": "CRM", "description": "CRM Menú móvil"}'),
    ('es', 'access', 'resource', 'd1eeab68-e4ff-4968-ac30-7936c2eb8300', '{"name": "Citas", "description": "Agendar cita móvil"}'),
    ('es', 'access', 'resource', '88d651f5-fbd1-4143-a95e-33b298940cd5', '{"name": "BPM", "description": "Workflow Menú de opciones"}'),
    ('es', 'access', 'resource', 'f1052511-dfb4-4a16-81de-2ade7b566e51', '{"name": "Parámetros", "description": "Parámetros del sistema"}'),
    ('es', 'access', 'resource', 'cd196477-3fb2-437f-a052-d6589bb8d51e', '{"name": "Secretos", "description": "Secretos y credenciales"}'),
    ('es', 'access', 'resource', 'd4903388-bb70-448d-b953-23c1e9fdcd8d', '{"name": "Bandeja de entrada", "description": "Bandeja de tareas pendientes"}'),
    ('es', 'access', 'resource', '00ee0b63-9e2a-428e-9b52-464e698747a4', '{"name": "Procesos", "description": "Procesos de negocio"}'),
    ('es', 'access', 'resource', 'ab88a015-24f3-466f-ba50-24f51cfdf1e5', '{"name": "Producción", "description": "Módulo de producción móvil"}'),
    ('es', 'access', 'resource', 'e865e125-614d-49ef-87a6-95b1c0c8dcf0', '{"name": "Productos", "description": "Definición de productos"}'),
    ('es', 'access', 'resource', 'd9777303-6d70-4a4d-b64c-1930c155cc2c', '{"name": "Unidades operativas", "description": "Unidades de operación"}'),
    ('es', 'access', 'resource', '44d0d0dc-66db-472e-aca2-ad41e3c3e0cc', '{"name": "Ordenes de producción", "description": "Ordenes de producción"}'),
    ('es', 'access', 'resource', '9074a402-5eb2-41e0-8156-05c972ed064c', '{"name": "Producción", "description": "Registro de producción"}'),
    ('es', 'access', 'resource', '838b9e54-40fe-4fed-8953-bcf2f02fbef2', '{"name": "Almacén", "description": "Módulo de almacén móvil"}'),
    ('es', 'access', 'resource', 'fe0012bf-6634-4b27-9c46-f00697c98633', '{"name": "Configuración", "description": "Configuración de almacén móvil"}'),
    ('es', 'access', 'resource', '9a287fc6-072b-43c5-9b5a-754e1df55f7e', '{"name": "Movimientos", "description": "Movimientos de almacén móvil"}'),
    ('es', 'access', 'resource', 'adb4d036-7ef9-4efe-8aed-b81b8150e6fc', '{"name": "Reportes", "description": "Reportes de almacén móvil"}'),
    ('es', 'access', 'resource', '84da0f58-0ef4-4aad-bfa4-ec6c10d98acd', '{"name": "Almacén", "description": "Gestión de almacén móvil"}'),
    ('es', 'access', 'resource', '41df3342-f050-4df3-a92a-427071f1bb1b', '{"name": "Salida", "description": "Salida de mercadería móvil"}'),
    ('es', 'access', 'resource', '532fc514-b931-4ab2-8dc0-4b1ed6c9be57', '{"name": "Ingreso", "description": "Ingreso de mercadería móvil"}'),
    ('es', 'access', 'resource', 'a2a7cf2a-f82f-412c-83ef-4f75319a26f6', '{"name": "Inventario", "description": "Inventario físico móvil"}'),
    ('es', 'access', 'resource', '4f0aa85e-d9d4-414a-bb1d-6bdf8543f2d3', '{"name": "Nivel de stock", "description": "Nivel de stock móvil"}'),
    ('es', 'access', 'resource', '9684c1de-8251-4bbb-b695-e92fa76e3457', '{"name": "Movimiento diario", "description": "Movimiento diario móvil"}'),
    ('es', 'access', 'resource', '0dfa49df-c34b-45d2-a35a-4259e0b79597', '{"name": "Kárdex", "description": "Kárdex físico móvil"}'),
    ('es', 'access', 'resource', '37aa3f87-1d14-4507-b13e-af7266acba85', '{"name": "Ventas", "description": "Ventas móvil"}'),
    ('es', 'access', 'resource', 'e48709a4-81c5-4b60-bf2a-286d8a59baf6', '{"name": "Parámetros", "description": "Módulo de parámetros móvil"}'),
    ('es', 'access', 'resource', '263fa8dc-1bfc-4a6f-8265-ea76788f9d65', '{"name": "Parámetro-Vendor", "description": "Parámetro-Vendor móvil"}'),
    ('es', 'access', 'resource', 'd61d0e3f-f95f-432b-abea-b0945223f455', '{"name": "Parámetros", "description": "Parámetros de CRM móvil"}'),
    ('es', 'access', 'resource', '8b3947c1-91b9-41ff-9413-3adae38cfe43', '{"name": "Accesos", "description": "Módulo de accesos y seguridad"}'),
    ('es', 'access', 'resource', '79aea72a-ae96-4ae3-93e0-1fe3b008e173', '{"name": "Parámetros", "description": "Parámetros de almacén móvil"}'),
    ('es', 'access', 'resource', '46b8fa34-d506-42f0-9108-93a337b0aaeb', '{"name": "BPM", "description": "Módulo de workflow móvil"}'),
    ('es', 'access', 'resource', '17df9706-349a-40d8-b947-a11ffa90554b', '{"name": "Bandeja", "description": "Bandeja de tareas móvil"}'),
    ('es', 'access', 'resource', 'ab598ac3-a127-4d8d-9e73-e4af8056628e', '{"name": "Procesos", "description": "Procesos móvil"}'),
    ('es', 'access', 'resource', 'ece5f0e0-4989-4c7c-ad83-586b9f7781a2', '{"name": "Entidades", "description": "Entidades del sistema móvil"}'),
    ('es', 'access', 'resource', 'de92092a-f570-4a60-96fc-dd280a6da433', '{"name": "Accesos", "description": "Módulo de accesos móvil"}'),
    ('es', 'access', 'resource', '4b7bbc10-b07b-4110-b524-28009e2993cf', '{"name": "Recursos", "description": "Gestión de recursos de acceso"}'),
    ('es', 'access', 'resource', '9f687da6-67fe-46a5-9ded-b2fa5cf1e5bf', '{"name": "Recursos", "description": "Gestión de recursos móvil"}'),
    ('es', 'access', 'resource', '161a43db-039e-4061-8562-fc220983ef1b', '{"name": "Menú", "description": "Estructura de menús"}'),
    ('es', 'access', 'resource', '6115a0c2-6385-4310-8235-1c0c45fa2691', '{"name": "Roles", "description": "Gestión de roles móvil"}'),
    ('es', 'access', 'resource', 'a734ded9-7366-4d84-ba90-8e321bbde515', '{"name": "Roles", "description": "Gestión de roles y permisos"}'),
    ('es', 'access', 'resource', '8061bbbb-e377-4e46-9c25-28239dd531ca', '{"name": "Perfiles", "description": "Gestión de perfiles móvil"}'),
